...
import {
  ...
  CardHeader,
  CardTitle,
} from "@orthfx/ui/components/ui/card";
      ...
      <div className="w-full max-w-2xl space-y-8">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-muted-foreground text-lg">
            Support your local parish and community campaigns.
          </p>
        </div>
            ...
            return (
              <Card key={page._id} className="w-full shadow-lg border-border">
                ...
                <CardHeader>
                  ...
                  <CardDescription>{page.storyRichText}</CardDescription>
                </CardHeader>
                ...
                <CardContent className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        <span className="font-semibold">
                          ${(fund.amountRaised / 100).toLocaleString()} raised
                        </span>
                        <span className="text-muted-foreground">
                          {Math.round(progressPercent)}% of $
                          {(fund.financialGoal! / 100).toLocaleString()}
                        </span>
                      </div>
                  ...
                  <div className="space-y-3">
                    <Label htmlFor={`amount-${page._id}`} className="text-base font-semibold">
                      Make a Donation
                    </Label>
                    <div className="flex gap-4">
                      ...
                      <Button size="lg" className="w-32 text-lg">
                        Donate
                      </Button>
                    </div>
